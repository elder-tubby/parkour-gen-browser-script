...
.dropdown {
  display: block; /* Make the select element block-level */
  width: 100%;     /* Ensure it takes up 50% of the available container width */
  padding: 5px;
  border: 1px solid #ccc;
  border-radius: 4px;
  font-size: 14px;
...
#mapsListDropdownContainer {
  width: 100%;  /* Make sure containers are full width */
  /* padding: 5px; */
}
